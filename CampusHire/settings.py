"""
Django settings for CampusHire project.
...
SESSION_EXPIRE_AT_BROWSER_CLOSE = True  # This ensures the session ends when the browser is closed
...
SITE_ID = 1  # Update if multiple sites are used
...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        'APP': {
            'client_id': 'your-client-id.apps.googleusercontent.com',   # Replace with Google client ID
        ...
        'REDIRECT_URI': 'https://127.0.0.1:8080/accounts/google/login/callback/',  # Replace with redirect URI
    }
}
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'ganeshnagpure5402@gmail.com'
EMAIL_HOST_PASSWORD = 'tajuufjkjcgowvmv'
